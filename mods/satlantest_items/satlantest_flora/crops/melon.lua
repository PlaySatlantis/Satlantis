satlantis.register_item("flora:melon_seeds", {
    ...
    crop = {
        next_stage = "flora:melon_crop_stage1",
    },
        ...
        for melon_param2, offset in pairs(rotations) do
            ...
            if minetest.get_node(adjacent).name == "air" then
                if minetest.registered_nodes[minetest.get_node(support).name].walkable then
                    ...
                    minetest.set_node(pos, {name = "flora:melon_crop_stage8", param2 = offset[2]})
...
for i = 1, stages do
    ...
    if i ~= stages then
        crop.next_stage = "flora:melon_crop_stage" .. i + 1
        ...
        crop.on_grow = function(pos, node)
            minetest.set_node(pos, {
                name = "flora:melon_crop_stage" .. i + 1,
    ...
    satlantis.register_block("flora:melon_crop_stage" .. i, {
        drawtype = "plantlike",
        waving = 1,
        tiles = {"melon_crop_stage" .. i .. ".png"},
        paramtype = "light",
