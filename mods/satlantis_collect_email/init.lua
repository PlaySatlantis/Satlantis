...
local form_name = "satlantis_collect_email:form"

function satlantis_collect_email.get_formspec(error_msg)
...
function satlantis_collect_email.show_collect_email_form(p_name)
