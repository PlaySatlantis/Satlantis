wiki.fmspecs_cache = {} -- ["file.md"] = formspec
...
minetest.register_on_player_receive_fields(function(player, formname, fields)
	...
	if not app or app.technical_name ~= "wiki:wiki" then return false end
