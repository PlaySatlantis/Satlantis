...
function get_quest(y, quest, is_completed, show_box)
	...
	if is_completed then
		...
		name = "hypertext[2,0.1;5.3,1;pname_txt;<global size=20 valign=middle><style color=#abc0c0><b>"..q.def.title.."</b>]"
		desc = "hypertext[2,0.85;3.2,1.1;pname_txt;<global size=14><style color=#7a9090><i>"..q.def.description.."</i>]"
		progress = ""
		points_icon = "image[5.9,1.75;0.22,0.3;bl_gui_profile_infobox_money.png^[multiply:#aaaaaa]"
		points = ("hypertext[5.4,1.75;2.1,0.4;pname_txt;<global size=14 halign=center><style color=#7a9090><b>%s</b>]"):format(q.def.points or "0")
		...
		name = "hypertext[2,0.1;5.3,1;pname_txt;<global size=20 valign=middle><b>"..q.def.title.."</b>]"
		desc = "hypertext[2,0.85;3.2,1.1;pname_txt;<global size=14><style color=#cfc6b8><i>"..q.def.description.."</i>]"
		points_icon = "image[5.9,1.75;0.22,0.3;bl_gui_profile_infobox_money.png]"
		points = ("hypertext[5.4,1.75;2.1,0.4;pname_txt;<global size=14 halign=center><b>%s</b>]"):format(q.def.points or "0")
